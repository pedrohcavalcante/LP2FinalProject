...
public class TelaPrincipal extends JFrame {
	 ...
	 * @throws ClassNotFoundException tratamento de exceÁ„o
	 * @throws InstantiationException tratamento de exceÁ„o
	 * @throws IllegalAccessException tratamento de exceÁ„o
	 * @throws UnsupportedLookAndFeelException tratamento de exceÁ„o
	 */
	public TelaPrincipal() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
		...
		/**
		 * MÈtodo para exibir a janela que adiciona uma pasta
		 */
		...
		adicionarPlaylist.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (login.getUsuarioAtual().getVip() == true) {
					...
					// Cria e adiciona uma nova playlist √Ø¬ø¬Ω lista
